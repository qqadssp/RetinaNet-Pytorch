...
from utils.utils import meshgrid, box_iou, box_nms, change_box_order
...
class DataEncoder:
    def __init__(self, input_scales):
        ...
        self.aspect_ratios = cfg.RETINANET.ASPECT_RATIOS
        self.scale_ratios = cfg.RETINANET.SCALE_RATIOS
